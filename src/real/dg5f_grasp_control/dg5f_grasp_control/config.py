...
class RuntimeConfig:
    ...
    blind_thumb_j1_target_rad: float = 0.2801
    blind_thumb_j2_target_rad: float = -1.5235
    blind_thumb_j3_target_rad: float = -0.0419
    blind_thumb_j4_target_rad: float = 0.9315
    ...
    blind_thumb_low_area_j4_target_rad: float = 0.9315
    ...
    blind_thumb_lift_j1_target_rad: float = 0.2789
    blind_thumb_lift_j2_target_rad: float = -1.5046
    blind_thumb_lift_j3_target_rad: float = -0.2473
    blind_thumb_lift_j4_target_rad: float = 1.2418
