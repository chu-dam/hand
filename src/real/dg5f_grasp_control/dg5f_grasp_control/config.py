...
class RuntimeConfig:
    ...
    compensation_mode_topic: str = "/dg5f_grasp_control/compensation_mode"
    ...
    blind_pinky_regrasp_sec: float = 0.50
    blind_reverse_sphere_estimate_sec: float = 0.50
    blind_motion_min_sec: float = 0.08
    blind_motion_stable_sec: float = 0.08
    blind_joint_velocity_threshold_rad_s: float = 0.05
    blind_sphere_stable_sample_count: int = 3
    blind_sphere_stable_max_deviation_m: float = 0.002
    blind_pinky_regrasp_alpha1: float = 5.0
    blind_finger_release_deg: float = 6.0
    blind_middle_release_deg: float = 3.0
    blind_forward_middle_j3_release_deg: float = 5.0
    blind_pinky_release_deg: float = 10.0
    blind_pinky_regrasp_j1_target_rad: float = 0.8358
    blind_pinky_regrasp_j2_target_rad: float = 1.2861
    blind_pinky_regrasp_j3_target_rad: float = 0.7721
    blind_pinky_regrasp_j4_target_rad: float = 0.6557
    blind_finger_j1_release_deg: float = 19.0
    blind_thumb_j1_target_rad: float = 0.1168
    blind_thumb_j2_target_rad: float = -1.6596
    blind_thumb_j3_target_rad: float = -0.1108
    blind_thumb_j4_target_rad: float = 0.9184
    blind_thumb_missed_down_j1_target_rad: float = 0.0799
    blind_thumb_missed_down_j2_target_rad: float = -1.6336
    blind_thumb_missed_down_j3_target_rad: float = 0.2443
    blind_thumb_missed_down_j4_target_rad: float = 0.2649
    blind_reverse_thumb_missed_down_j1_target_rad: float = 0.3368
    blind_reverse_thumb_missed_down_j2_target_rad: float = -1.3441
    blind_reverse_thumb_missed_down_j3_target_rad: float = 0.2843
    blind_reverse_thumb_missed_down_j4_target_rad: float = 0.2733
    blind_reverse_thumb_j1_target_rad: float = 0.3238
    blind_reverse_thumb_j2_target_rad: float = -1.3102
    blind_reverse_thumb_j3_target_rad: float = -0.1991
    blind_reverse_thumb_j4_target_rad: float = 0.8927
    blind_reverse_pinky_release_deg: float = 10.0
    blind_sphere_lift_world_z_threshold_m: float = 0.140
    blind_fk_sphere_lift_world_z_threshold_m: float = 0.1345
    blind_fk_sphere_down_world_z_threshold_m: float = 0.139
    blind_thumb_lift_j1_target_rad: float = 0.1136
    blind_thumb_lift_j2_target_rad: float = -1.6558
    blind_thumb_lift_j3_target_rad: float = -0.2618
    blind_thumb_lift_j4_target_rad: float = 1.5010
    blind_reverse_thumb_lift_j1_target_rad: float = 0.3506
    blind_reverse_thumb_lift_j2_target_rad: float = -1.3271
    blind_reverse_thumb_lift_j3_target_rad: float = -0.4472
    blind_reverse_thumb_lift_j4_target_rad: float = 1.5382
