...
class RuntimeConfig:
    ...
    blind_reverse_thumb_missed_down_j1_target_rad: float = 0.3641
    blind_reverse_thumb_missed_down_j2_target_rad: float = -1.3364
    blind_reverse_thumb_missed_down_j3_target_rad: float = 0.2763
    blind_reverse_thumb_missed_down_j4_target_rad: float = 0.2896
    blind_reverse_thumb_j1_target_rad: float = 0.3848
    blind_reverse_thumb_j2_target_rad: float = -1.3345
    blind_reverse_thumb_j3_target_rad: float = -0.0300
    blind_reverse_thumb_j4_target_rad: float = 0.7479
    ...
    blind_thumb_lift_j4_target_rad: float = 1.2217
    blind_reverse_thumb_lift_j1_target_rad: float = 0.3756
    blind_reverse_thumb_lift_j2_target_rad: float = -1.3345
    blind_reverse_thumb_lift_j3_target_rad: float = -0.4346
    blind_reverse_thumb_lift_j4_target_rad: float = 1.4331
